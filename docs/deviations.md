...
|---|---|---|---|---|
| SDK pin is `10.0.302` | This is the installed stable .NET 10 feature band used by CI bootstrap | Replaces the older planning example `10.0.1xx` | Accept exact stable SDK and latest patch only | Step 01 evidence |
