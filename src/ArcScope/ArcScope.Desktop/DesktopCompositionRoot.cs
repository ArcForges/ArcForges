...
/// <summary>
/// The one place where ArcScope desktop services are registered. Steps 05+ add their
...
internal static class DesktopCompositionRoot
{
    ...
    /// <summary>
    /// The extension point owned by the steps that add ArcScope background work. It is
