...
/// <summary>
/// The single explicit seam through which ArcNotes background work reaches the desktop host.
        ...
        where TService : class, IHostedService
    {
        ...
        if (!_factories.TryAdd(typeof(TService), factory))
        {
            throw new InvalidOperationException(
                $"{typeof(TService)} is already registered with the ArcNotes hosted-service registry.");
        }
