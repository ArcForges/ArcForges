...
/// <summary>
/// The one place where ArcNotes desktop services are registered. Steps 05+ add their
...
internal static class DesktopCompositionRoot
{
    ...
    /// <summary>
    /// The extension point owned by the steps that add ArcNotes background work. It is
