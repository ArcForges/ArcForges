...
/// <summary>
/// The one place where ArcChat desktop services are registered. Steps 05+ add their
...
internal static class DesktopCompositionRoot
{
    ...
    /// <summary>
    /// The extension point owned by the steps that add ArcChat background work. It is
