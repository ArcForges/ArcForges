...
{
    [Xunit.Fact(Skip = "Owned by Step 06. Unlock when shared design tokens, commands, settings and notifications exist.")]
    [Xunit.Trait("Category", "Contract")]
    public void SharedExperienceInvariantsHoldAcrossProducts() =>
